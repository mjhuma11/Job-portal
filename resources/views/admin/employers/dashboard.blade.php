    ...
    <div class="flex">
        ...
        <div class="flex-1 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <!-- Posted Jobs -->
                <div class="bg-blue rounded-xl p-6 shadow-lg transform transition-all duration-300 hover:scale-105">
                    <div class="flex items-center justify-between">
                        <div>
                            <div class="text-3xl font-bold text-white">{{ $stats['posted_jobs'] }}</div>
                ...
                <!-- Total Applications -->
                <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-xl p-6 shadow-lg transform transition-all duration-300 hover:scale-105">
                    <div class="flex items-center justify-between">
                        <div>
                ...
                <div class="bg-gradient-to-r from-amber-500 to-amber-600 rounded-xl p-6 shadow-lg transform transition-all duration-300 hover:scale-105">
                    <div class="flex items-center justify-between">
                        <div>
                            <div class="text-3xl font-bold text-white">{{ $stats['shortlisted_candidates'] }}</div>

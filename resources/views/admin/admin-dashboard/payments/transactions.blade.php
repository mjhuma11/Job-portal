    ...
    <div class="flex">
        ...
        <div class="flex-1 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                        <div>
                            ...
                            <input type="text" name="search" id="search" 
                                   ...
                                   placeholder="Search by employer or transaction ID" value="">
                        </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">bKash</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">#TXN-001422</div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="text-sm font-medium text-gray-900">Creative Designs Co.</div>
                                    <div class="text-sm text-gray-500">info@creativedesigns.com</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">Premium Plan</div>
                                </td>
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6 mt-6">
                <h3 class="text-lg font-medium text-gray-900 mb-4">Export Transactions</h3>

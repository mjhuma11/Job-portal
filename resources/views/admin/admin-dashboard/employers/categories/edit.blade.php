...
@section('title', 'Edit Category - CareerBridge')
        ...
        <div class="flex-1 p-6">
            ...
            <div class="mb-6">
                <div class="flex items-center space-x-2 text-sm text-gray-500 mb-2">
                    ...
                    <span class="text-blue-600">Edit Category</span>
                </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border">
                ...
                <form action="{{ route('employer.categories.update', $category) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="description" name="description" rows="4" 
                                      ...
                                      class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500">{{ old('description', $category->description) }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            @endif
                            <p class="mt-1 text-xs text-gray-500">Upload a new image to replace the current one (optional)</p>
                        </div>

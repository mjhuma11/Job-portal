    ...
    <div class="flex">
        ...
        <div class="flex-1 p-6">
            ...
            <div class="mb-6">
                ...
                <p class="text-gray-600 mt-1">Create a new job location</p>
            </div>
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="city" id="city" 
                                   ...
                                   placeholder="Enter city name" value="{{ old('city') }}" required>
                            @error('city')
                        ...
                        <div>
                            ...
                            <input type="text" name="country" id="country" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                   placeholder="Enter country name" value="{{ old('country') }}" required>
                            @error('country')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>

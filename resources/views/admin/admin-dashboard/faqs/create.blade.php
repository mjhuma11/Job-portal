    ...
    <div class="flex">
        ...
        <div class="flex-1 p-6">
            ...
            <div class="mb-6">
                ...
                <h1 class="text-3xl font-bold text-gray-900">Add New FAQ</h1>
                <p class="text-gray-600 mt-1">Create a new frequently asked question</p>
            </div>
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="name" id="name" 
                                   ...
                                   placeholder="Enter FAQ name or title" value="{{ old('name') }}" required>
                            @error('name')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="category" id="category" 
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                       placeholder="Enter category (e.g., General, Account, Jobs)" value="{{ old('category') }}">
                                @error('category')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="sort_order" id="sort_order" 
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                       placeholder="Enter sort order (0-999)" value="{{ old('sort_order', 0) }}" min="0" max="999">
                                @error('sort_order')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
